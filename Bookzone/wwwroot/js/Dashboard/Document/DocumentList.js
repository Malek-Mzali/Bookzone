...
$(document).ready(function () {
    ...
    $("#editBookform").data("validator").settings.ignore = "";
    ...
    $("#editBookform").submit(function (e) {
        ...
        if ($("#txtDocumentType").val() === "Ebook") {
            if ($("#txtIssn").val() !== "")
                $(".issn").val($("#txtIssn").val())
            else
                $(".issn").val("00000000");
        } else {
            if ($("#txtIsbn").val() !== "")
                $(".isbn").val($("#txtIsbn").val())
            else
...
function loadDataTable() {
    ...
    if ($.fn.DataTable.isDataTable('#BooksList')) {
        ...
        $('#BooksList').dataTable().fnClearTable();
        $('#BooksList').dataTable().fnDestroy();
    ...
    var dataTable = $('#BooksList').dataTable({
                    ...
                    return `
                     <div class="text-center">
                        ...
                        <ul aria-labelledby="dropdownMenuButton3" class="dropdown-menu dropdown-menu-right" id="dropdownList2">
                            ...
                            <li>
                                <a class="dropdown-item" href="#" data-bs-toggle="modal" onclick="EditBtnDocument(${data})" data-bs-target="#editDocument"><i class="fas fa-edit m-r-5"></i> Edit</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="#" data-bs-toggle="modal" onclick="SummaryBtnDocument(${data})" data-bs-target="#summaryDocument"><i class="fas fa-bookmark m-r-5"></i> Summary</a>
                            </li>
                            <li>
...
function EditBtnDocument(obj) {
    ...
    var x = dataresult.data.map(function (x) {
        return x.documentGroup.id;
    }).indexOf(obj);
    console.log(x)
    ...
    $("#txtDocumentType").val(dataresult.data[x].documentGroup.documentType).trigger('change');
