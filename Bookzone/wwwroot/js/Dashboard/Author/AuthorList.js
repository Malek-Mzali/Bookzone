...
function EditBtnAuthor(obj) {
    //var x = $(obj).closest('tr').index() + ($('#AuthorList').DataTable().page.info().page * 10)
                    ...
                    return `
                     <div class="text-center">
                        ...
                        <ul aria-labelledby="dropdownMenuButton2" class="dropdown-menu dropdown-menu-right" id="dropdownList2">
                            ...
                            <li>
                                <a class="dropdown-item" href="#" data-bs-toggle="modal" onclick="EditBtnAuthor(${data})" data-bs-target="#editAuthor"><i class="fas fa-edit m-r-5"></i> Edit</a>
                            </li>
                            <li>
