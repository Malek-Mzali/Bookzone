...
";
            ...
            Address =
                new ConfigurationBuilder().AddJsonFile("appsettings.json").Build()
                    .GetSection("EmailGateway")["Address"];
            Password = new ConfigurationBuilder().AddJsonFile("appsettings.json").Build()
                .GetSection("EmailGateway")["Password"];
            From = new ConfigurationBuilder().AddJsonFile("appsettings.json").Build()
                .GetSection("EmailGateway")["From"];
            Subject = new ConfigurationBuilder().AddJsonFile("appsettings.json").Build()
                .GetSection("EmailGateway")["Subject"];
            Link =
                new ConfigurationBuilder().AddJsonFile("appsettings.json").Build()
        ...
        public string BodyReset { get; set; }
